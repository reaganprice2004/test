...
public:
    ...
    Book() {
        ...
        cout << "Default constructor called." << endl; // observe constructor call (at very beginning)
    }
    ...
    // challenge - overloaded constructor (ititializes only title and author), year and price set to 0
    ...
    } // line above should print 3 times at the end - indicates all 3 book objects destroyed
...
int main() {
    ...
    Book book3("The Lord of the Rings", "J.R.R. Tolkien", 1954, 14.99);
    cout << endl;
